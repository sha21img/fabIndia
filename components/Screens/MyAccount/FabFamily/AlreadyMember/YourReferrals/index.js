                        ...
                        {data.map(el => {
                            return (
                                <View
                                    ...
                                    <View>
                                        <Text style={{ color: el.status != 'Pending' ? '#96AD66' : '#FAA859' }}>{el.status}</Text>
                                    </View>
                                </View>
                            );
                        })}
                                ...
                                {Options.map((option, id) => (
                                    <View key={id} style={styles.optionView}>
                                        <Image
                                            ...
                                            source={option.image}
                                        />
                                        <Text style={styles.optionTxt}>{option.Name}</Text></View>
                                ))}
                            </View>
